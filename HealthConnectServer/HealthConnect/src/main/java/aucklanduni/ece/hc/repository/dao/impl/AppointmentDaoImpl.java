...
public class AppointmentDaoImpl  extends BaseDaoImpl<Appointment> implements AppointmentDao{
	...
	/**
	 * @Title: findAppointmentByGroupId
	 * @Description: Function will return all appointments that belong
	 * to the given groupId list and are shared with the entire group i.e
	 * SHARED_TYPE column in APPOINTMENT table is set as 'G'.
	 * 
	 * @param List<Long> groupId
	 * @return List<Appointment>
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @Title: findAppByGroupIdMemberId
	 * @Description: Function will return all appointments that belong
	 * to the given groupId list and and are shared with both, the input 
	 * memberId and accountId.
	 * 
	 * @param List<Long> groupId
	 * @param memberId
	 * @param accountId
	 ...
	 * @throws Exception
	 */
	public List<Appointment> findAppByGroupIdMemberId(List<Long> groupId, 
			long memberId, long accountId) throws Exception {
		try {
			Session s=getSession();
			String hql=
	...
	/**
	 * @Title: findAppByGroupIdAccountId
	 * @Description: Function will return all appointments that belong to
	 * the given groupId list and and are shared with the input accountId.
	 * 
	 * @param List<Long> groupId
	 * @param accountId
	 * @return List<Appointment>
	...
	/**
	 * @Title: findAppByDate
	 * @Description: Function will filter all appointments from the given
	 * appointment list on the basis of input dates.
	 * 
